...
module.exports.processMessage = async (event) => {
  ...
  try {
    ...
    console.log(`[processMessage] XSD validation (v1): ${results[0].status}`)
    console.log(`[processMessage] JOI validation (v1): ${results[1].status}`)
    console.log(`[processMessage] XSD validation (v2): ${results[2].status}`)
    console.log(`[processMessage] JOI validation (v2): ${results[3].status}`)
